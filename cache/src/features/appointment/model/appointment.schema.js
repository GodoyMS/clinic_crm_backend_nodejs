...
const appointmentSchema = new mongoose_1.Schema({
    ...
    patient: { type: mongoose_1.default.Schema.Types.ObjectId, ref: 'UserPatient' },
    doctor: { type: mongoose_1.default.Schema.Types.ObjectId, ref: 'UserDoctor' },
    dateStart: { type: Date, default: '' },
    dateEnd: { type: Date, default: '' },
    reason: { type: String }
});
const AppointmentModel = (0, mongoose_1.model)('Appointment', appointmentSchema, 'Appointment');
