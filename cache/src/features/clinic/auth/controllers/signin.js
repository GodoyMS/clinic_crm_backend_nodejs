...
const signin_1 = require("@clinic/auth/schemes/signin");
class SignIn {
    read(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const { email, password } = req.body;
            const existingUser = yield clinicAuth_service_1.authService.getAuthUserByEmail(email);
            if (!existingUser) {
            ...
            res.status(http_status_codes_1.default.OK).json({ message: 'User login successfully', user: existingUser, token: userJwt });
        });
    }
}
__decorate([
