...
exports.UpdateClinicHistory = void 0;
...
class UpdateClinicHistory {
    upload(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const existingPatient = yield patientUser_service_1.userService.updateClinicHistoryPatientById(patientID, `${pdfResult.secure_url}`);
            if (!existingPatient) {
    ...
    delete(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                yield (0, deleteCloudinaryFileByURL_1.deleteFile)(historyUrl);
            }
            catch (error) {
                throw new badRequestError_1.BadRequestError('Could not delete file from cloudinary');
            }
            const existingPatient = yield patientUser_service_1.userService.deleteClinicHistoryPatientById(patientID, `${historyUrl}`);
            if (!existingPatient) {
                throw new badRequestError_1.BadRequestError('Invalid credentials');
            }
            yield existingPatient.save();
...
exports.UpdateClinicHistory = UpdateClinicHistory;
//# sourceMappingURL=updateClinicHistory.js.map