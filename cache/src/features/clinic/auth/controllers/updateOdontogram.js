...
class UpdateOdontogram {
    upload(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const existingPatient = yield patientUser_service_1.userService.updateOdontogramPatientById(patientID, `${pdfResult.secure_url}`);
            if (!existingPatient) {
            ...
            res.status(http_status_codes_1.default.OK).json({
                message: 'Patient odontogram added succesfully ',
    ...
    delete(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                yield (0, deleteCloudinaryFileByURL_1.deleteFile)(odontogramUrl);
            }
            catch (error) {
                throw new badRequestError_1.BadRequestError('Could not delete file from cloudinary');
            }
            const existingPatient = yield patientUser_service_1.userService.deleteODontogramPatientById(patientID, `${odontogramUrl}`);
            if (!existingPatient) {
                throw new badRequestError_1.BadRequestError('Invalid credentials');
            }
            yield existingPatient.save();
            ...
            //    : await userServicePatient.getUserById(patientID);
            res.status(http_status_codes_1.default.OK).json({
                message: 'Patient clinic odontogram deleted succesfully ',
                patient: existingPatient,
            });
        });
    }
}
exports.UpdateOdontogram = UpdateOdontogram;
//# sourceMappingURL=updateOdontogram.js.map