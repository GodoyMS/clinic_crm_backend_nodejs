...
const signin_1 = require("@patient/auth/schemes/signin");
class SignIn {
    ...
    read(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const existingUser = yield patientAuth_service_1.authService.getAuthUserByDni(dni);
            ...
            res.status(http_status_codes_1.default.OK).json({ message: 'Patient login successfully', user: existingUser, token: userJwt });
        });
    }
}
__decorate([
