...
class SignUpPatient extends signup_utility_1.SignUpUtility {
    create(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const authData = SignUpPatient.prototype.signUpData({
                _id: authObjectId,
            ...
            //}
            const userDataForCache = SignUpPatient.prototype.userData(authData, userObjectId);
            ...
            const userJwt = SignUpPatient.prototype.signToken(authData, userObjectId);
...
], SignUpPatient.prototype, "create", null);
