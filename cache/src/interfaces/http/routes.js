...
const authPatientRoutes_1 = require("../../features/patient/auth/routes/authPatientRoutes");
const clinicActions_1 = require("../../features/clinic/auth/routes/clinicActions");
const currentUser_1 = require("../../features/clinic/auth/routes/currentUser");
const currentUserPatient_1 = require("../../features/patient/auth/routes/currentUserPatient");
const clinicActionsUser_1 = require("../../features/clinic/user/routes/clinicActionsUser");
const authDoctorRoutes_1 = require("../../features/doctor/auth/routes/authDoctorRoutes");
const currentUserDoctor_1 = require("../../features/doctor/auth/routes/currentUserDoctor");
exports.default = (app) => {
    const routes = () => {
