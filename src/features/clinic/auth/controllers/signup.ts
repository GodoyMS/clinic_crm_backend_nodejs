...
import { signupSchema } from '@clinic/auth/schemes/signup';
...
import { userQueue } from '@services/queues/clinicUser.queue';
import { authQueue } from '@services/queues/clinicAuth.queue';
...
export class SignUp extends SignUpUtility {
  ...
  public async create(req: Request, res: Response): Promise<void> {
    ...
    authQueue.addAuthUserJob('addAuthUserClinicToDB', { value: userDataForCache });
    userQueue.addUserJob('addUserClinicToDB', { value: userDataForCache });
