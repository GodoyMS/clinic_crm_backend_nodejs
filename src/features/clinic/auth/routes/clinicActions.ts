...
import { upload, uploadFile } from '@helpers/multer/storage';
...
class ClinicAuthActionsRoutes {
   ...
   public patientActions():Router{
      ...
      this.router.put('/uploadClinicHistory/:id',authMiddleware.checkAuthentication, upload, UpdateClinicHistory.prototype.upload);
      this.router.put('/uploadOdontogram/:id',authMiddleware.checkAuthentication, upload, UpdateOdontogram.prototype.upload);
      this.router.put('/uploadConsent/:id',authMiddleware.checkAuthentication, upload, UpdateConsent.prototype.upload);
      this.router.put('/deleteClinicHistory/:id',authMiddleware.checkAuthentication, UpdateClinicHistory.prototype.delete);
   ...
   public appointmentActions():Router{
      this.router.post('/appointment/registerAppointment',authMiddleware.checkAuthentication,Appointment.prototype.create);
      this.router.get('/appointment/getClinicAppointments',authMiddleware.checkAuthentication,GetClinicAppointments.prototype.read);
      this.router.delete('/appointment/deleteClinicAppointment/:id',authMiddleware.checkAuthentication,DeleteAppointment.prototype.delete);
      this.router.post('/appointment/deleteManyClinicAppointments',authMiddleware.checkAuthentication,DeleteManyAppointments.prototype.delete);

      this.router.get('/appointment/getClinicAppointment/:id',authMiddleware.checkAuthentication,GetClinicAppointmentById.prototype.read);
